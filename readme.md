...
1. Clone the base boilerplate in the folder **assignment-solution-step1** of your local machine
    ...
    `git clone https://gitlab-ibm.stackroute.in/stack_java_keep/KeepNote-Step1-Boilerplate.git`
...
5. Add your new repository reference as remote
     ...
     `git remote add origin https://gitlab-ibm.stackroute.in/{{yourusername}}/assignment-solution-step1.git`
